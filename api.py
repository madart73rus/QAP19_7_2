...
# pf = PetFriends()
# pet_id =  'ee6f75d9-00a5-4b1b-b248-ef17b09a081a'
# path_photo = 'cat1.jpg'
# _, rs = pf.get_api_key(settings.valid_email, settings.valid_password)
# print(rs)
# _, rs2 = pf.get_list_of_pets(rs, 'my_pets')
# rs3 = pf.set_pet_photo(rs, pet_id, path_photo)
# print(rs3)
# pf.create_pet_simple(rs, 'pirat', 'Cat', '2')